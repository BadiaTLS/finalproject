...
@user_passes_test(check_student_role, login_url='not_student')
@transaction.atomic
def confirm_action(request, current_hour, current_date, session, time_objects, menu_object):
    context = None
...
def confirm(request):
    ...
    return confirm_action(request, current_hour, current_date, session, time_objects, menu_object)
